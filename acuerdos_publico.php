                    ...
                    <table class="datatable table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php foreach ($all_acuerdos as $a_acuerdo) : ?>
                                <tr>
                                    <td class="text-center"><?php echo remove_junk(ucwords($a_acuerdo['folio_acuerdo'])) ?></td>
                                    <td class="text-center"><?php echo remove_junk(ucwords($a_acuerdo['folio_queja'])) ?></td>
