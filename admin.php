...
<div class="row" style="margin-top: 5px;">
  <div class="col-md-3" style="height: 12.5rem;">
    <div class="panel panel-box clearfix">
      ...
      <div class="panel-value pull-right">
        <h2 class="margin-top"> <?php echo $c_acuerdos['total']; ?></h2>
  ...
  <div class="col-md-3" style="height: 12.5rem;">
    <div class="panel panel-box clearfix">
      ...
      <div class="panel-value pull-right">
        <h2 class="margin-top"> <?php echo $c_recomendaciones['total']; ?></h2>
...
<div class="row" style="margin-top: 5px;">  
  <div class="col-md-3" style="height: 12.5rem;">
    <div class="panel panel-box clearfix">
      ...
      <div class="panel-value pull-right">
        <h2 class="margin-top"> <?php echo $c_resoluciones['total']; ?> </h2>
  ...
  <div class="col-md-3" style="height: 12.5rem;">
    <div class="panel panel-box clearfix">
      ...
      <div class="panel-value pull-right">
        <h2 class="margin-top"> <?php echo $c_consejo['total']; ?> </h2>
  ...
  <div class="col-md-3" style="height: 12.5rem;">
    <div class="panel panel-box clearfix">
      ...
      <div class="panel-value pull-right">
        <h2 class="margin-top"> <?php echo $c_correspondencia['total']; ?> </h2>
        <p class="text-muted">Correspondencia</p>
      </div>
    </div>
  </div>
  <div class="col-md-3" style="height: 12.5rem;">
