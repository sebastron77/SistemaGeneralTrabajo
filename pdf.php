    ...
    <tbody>
      <?php foreach ($resguardos as $resguardo) : ?>
        <?php if($resguardo['estatus_asignacion'] == 1): ?>
          <tr>
            <td><?php echo remove_junk($resguardo['cantidad']); ?></td>
            <td><?php echo remove_junk($resguardo['nombre_componente']); ?></td>
            <td><?php echo remove_junk($resguardo['descripcion_particular']); ?></td>
    ...
    <div style="border: solid 1px black; height: 130px;">
      <?php foreach ($resguardos as $resguardo) : ?>
        <?php if ($resguardo['estatus_asignacion'] == 1): ?>
          ...
          <?php else: ?>
            <?php echo remove_junk($resguardo['nombre_componente']) . ": " . remove_junk($resguardo['observaciones']); ?><br>
          <?php endif?>
        <?php endif?>
      <?php endforeach ?>
    </div>
