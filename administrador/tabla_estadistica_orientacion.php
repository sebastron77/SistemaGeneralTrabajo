                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="text-align:right;"><b>Total</b></td>
                            <td>
                                <?php echo $total_mujeres['total'] + $total_hombres['total'] + $total_lgbtiq['total'] ?>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="text-align:right;"><b>Total</b></td>
                            <td>
                                <?php echo $total_gv_lgbt['total'] + $total_der_mujer['total'] + $total_nna['total'] + $total_disc['total'] + $total_mig['total'] +
                                $total_vih['total'] + $total_gi['total'] + $total_perio['total'] + $total_ddh['total'] + $total_am['total'] + $total_int['total'] + 
                                $total_otros['total'] +$total_na['total'] ?>
                            </td>
                        </tr>
                    </tbody>
                </table>
