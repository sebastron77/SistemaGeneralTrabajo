...
<div class="row" style="margin-top: 10px;">
    <!-- <div class="col-md-3" style="height: 13.5rem;">
        <div class="panel panel-box clearfix">
            ...
            <div class="panel-value pull-right">
                <p style="font-size: 16px; margin-top:5%; color:#333333;">Resoluciones</p>
    ...
    <!-- <div class="col-md-3" style="height: 13.5rem;">
        <div class="panel panel-box clearfix">
            ...
            <div class="panel-value pull-right">
                <p style="font-size: 16px; margin-top:4%; color:#333333;">Consejo de la CEDH</p>
    ...
    <div class="col-md-3" style="height: 13.5rem;">
        <div class="panel panel-box clearfix">
            ...
            <div class="panel-value pull-right">
                <p style="font-size: 16px; margin-top:3%; color:#333333;">Programa Operativo Anual (POA)</p>
                <div style="margin-top:-3%;">
                    <?php if (($nivel_user <= 2) || ($nivel_user == 7)) : ?>
